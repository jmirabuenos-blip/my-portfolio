...
export default function ContactPage() {
  ...
  return (
    ...
    >
      {/* ── Page label ── */}
      <p
        className={`text-[10px] font-medium uppercase mb-8 transition-all duration-700
      ...
      >
        <h1
          className={`mb-3 ${dark ? "text-[#f0ebe2]" : "text-[#1e1a16]"}`}
          style={{
        ...
        <p
          className={`text-[15px] leading-relaxed max-w-sm ${dark ? "text-[#9e9187]" : "text-[#6b5f52]"}`}
      ...
      {/* ── Divider ── */}
      <div
        className={`h-px w-full mb-10 transition-all duration-700 ${s1 ? "opacity-100" : "opacity-0"}`}
        style={{
          background: dark
      ...
      {/* ── Contact links ── */}
      <div
        className={`flex flex-col gap-2 mb-10 transition-all duration-700
      ...
      >
        {CONTACT_LINKS.map((c) => (
          <a
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-md border text-sm transition-all duration-200 group hover:-translate-y-px
              ${dark
                ? "border-[#3a3028] text-[#9e9187] hover:bg-[#2a2318] hover:border-[#4a3a25] hover:text-[#c9a96e]"
                : "border-[#e0d4c0] text-[#6b5f52] hover:bg-[#f5efe6] hover:border-[#d4c4aa] hover:text-[#2c2825]"
              }`}
          >
            <span
              className={`transition-colors duration-200 ${dark ? "text-[#5a5048] group-hover:text-[#c9a96e]" : "text-[#b5a898] group-hover:text-[#8a6e48]"}`}
            >
              {c.icon}
            </span>
            <span
            ...
            <span
              className={`text-[12px] truncate max-w-[200px] transition-colors duration-200
                ${dark ? "text-[#5a5048] group-hover:text-[#7a6a58]" : "text-[#c4b9aa] group-hover:text-[#9a8f83]"}`}
            ...
            <svg
              ...
              className={`opacity-0 group-hover:opacity-40 transition-opacity flex-shrink-0 ${dark ? "text-[#c9a96e]" : "text-[#8a6e48]"}`}
            >
      ...
      {/* ── Divider ── */}
      <div
        className={`h-px w-full mb-8 transition-all duration-700 ${s3 ? "opacity-100" : "opacity-0"}`}
        style={{
          background: dark
            ? "linear-gradient(to right, transparent, #3a3028 30%, #3a3028 70%, transparent)"
            : "linear-gradient(to right, transparent, #e0d4c0 30%, #e0d4c0 70%, transparent)",
